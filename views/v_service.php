...
<!-- ================= SERVICE / HERO ================= -->
<section
  class="header-service mt-4 py-5 mb-5"
  style="
    ...
    <div class="services-swiper swiper">
      <div class="services-swiper__wrapper swiper-wrapper">
        ...
        <article class="services-swiper__slide swiper-slide">
          <div class="services-swiper__card" style="--bg:url('https://images.unsplash.com/photo-1521540216272-a50305cd4421?auto=format&fit=crop&w=1400&q=70');">
        ...
        <!-- Slide 2 -->
        <article class="services-swiper__slide swiper-slide">
          <div class="services-swiper__card" style="--bg:url('https://images.unsplash.com/photo-1503387762-592deb58ef4e?auto=format&fit=crop&w=1400&q=70');">
        ...
        <!-- Slide 3 -->
        <article class="services-swiper__slide swiper-slide">
          <div class="services-swiper__card" style="--bg:url('https://images.unsplash.com/photo-1581092580497-e0d23cbdf1dc?auto=format&fit=crop&w=1400&q=70');">
