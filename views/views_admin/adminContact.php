<?php
// views_admin/adminContact.php

$pageTitle = $pageTitle ?? "Admin Contact | OFLABIM";
$metaDesc  = $metaDesc  ?? "Administration de la page Contact";
$canonical = $canonical ?? "http://localhost/siteVitrine/index.php?page=adminContact";
?>
...
<div class="border rounded-3 p-4 bg-white">
    ...
    <div class="d-flex flex-wrap align-items-center justify-content-between gap-2 mb-3">
        <div>
            <h2 class="h5 mb-1">Contact — Administration</h2>
            <p class="text-muted mb-0">Choisissez une section de la page Contact à modifier.</p>
        </div>
    </div>
    ...
    <div class="row g-3 align-items-end mb-4">
        <div class="col-md-8">
            ...
            <select
                class="form-select"
                onchange="if (this.value) window.location.href='index.php?page=adminContact&section=' + encodeURIComponent(this.value); else window.location.href='index.php?page=adminContact';"
            >
        ...
        <div class="col-md-4 text-md-end">
            <a class="btn btn-outline-dark" href="index.php?page=contact" target="_blank">
